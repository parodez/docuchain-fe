...
const STATUS_OPTIONS = ["Pending", "Approved", "Rejected", "Processing"];
...
function Requests2() {
  ...
  if (isLoading) {
    return <div className="flex justify-center py-10">Loading requests...</div>;
  }
              ...
              {filteredRequests.map((request) => (
                <tr
                  ...
                  className={`cursor-pointer border-b transition hover:bg-[#2f9f63]/5 ${
                    selectedIds.includes(request.id) ? "bg-[#2f9f63]/10" : ""
                  }`}
                >
                  <td
                    className="px-4 py-4"
                  ...
                  <td className="px-4 py-4">{request.lrn}</td>

                  <td className="px-4 py-4">{request.purpose}</td>

                  <td className="px-4 py-4">{request.academic_year}</td>
        ...
        >
          ...
          >
            ...
            <div className="grid gap-4">
              <DetailItem label="Name" value={selectedRequest.name} />

              <DetailItem label="LRN" value={selectedRequest.lrn} />
              ...
              <DetailItem label="Purpose" value={selectedRequest.purpose} />
              ...
              <DetailItem label="Request ID" value={selectedRequest.id} />
            </div>
